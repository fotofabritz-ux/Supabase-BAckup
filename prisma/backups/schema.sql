...
CREATE TABLE IF NOT EXISTS "public"."XXX-global_events" (
...
ALTER TABLE "public"."XXX-global_events" OWNER TO "postgres";


COMMENT ON TABLE "public"."XXX-global_events" IS 'nicht gebraucht?';
...
CREATE TABLE IF NOT EXISTS "public"."platzdaten2" (
    "pl_ort" "text",
    "nr" bigint NOT NULL,
    "va_adresse" "text",
    "kal_notiz" "text" DEFAULT ''::"text",
...
ALTER TABLE "public"."platzdaten2" OWNER TO "postgres";


COMMENT ON TABLE "public"."platzdaten2" IS 'This is a duplicate of platzdaten';



COMMENT ON COLUMN "public"."platzdaten2"."pl_ort" IS 'Platz, Ort';



COMMENT ON COLUMN "public"."platzdaten2"."va_adresse" IS 'Veranstalter, Strassenname';



COMMENT ON COLUMN "public"."platzdaten2"."int_kontrolle" IS 'Internes Kontrollfeld';



COMMENT ON COLUMN "public"."platzdaten2"."pl_beschreibung" IS 'Beschreibung des Platzes';



COMMENT ON COLUMN "public"."platzdaten2"."pl_web" IS 'Platz, Webseite';



COMMENT ON COLUMN "public"."platzdaten2"."va_web" IS 'Veranstalter Webseite';



COMMENT ON COLUMN "public"."platzdaten2"."va_name" IS 'Veranstalter-Name';



COMMENT ON COLUMN "public"."platzdaten2"."pl_bez" IS 'Bezeichnung des Platzes';



COMMENT ON COLUMN "public"."platzdaten2"."XXX_pl_plz_alt" IS 'Alte Postleitzahl mit "D-"';



COMMENT ON COLUMN "public"."platzdaten2"."va_ort" IS 'Veranstalter, Ort';



COMMENT ON COLUMN "public"."platzdaten2"."pl_location" IS 'Platz, Lage des Platzes, Ortsbezeichnung';



COMMENT ON COLUMN "public"."platzdaten2"."kal_region" IS 'Kalender-Region';



COMMENT ON COLUMN "public"."platzdaten2"."pl_start" IS 'Platz, Startdatum';



COMMENT ON COLUMN "public"."platzdaten2"."pl_ende" IS 'Platz Enddatum';



COMMENT ON COLUMN "public"."platzdaten2"."futur_start" IS 'Zukünftige Termine Start';



COMMENT ON COLUMN "public"."platzdaten2"."pl_lat" IS 'Platz, Längengrad';



COMMENT ON COLUMN "public"."platzdaten2"."pl_lon" IS 'Platz, Breitengrad';



COMMENT ON COLUMN "public"."platzdaten2"."pl_gplus" IS 'Platz, G+-GeoDaten';



COMMENT ON COLUMN "public"."platzdaten2"."pl_attr" IS 'Platz, Anzahl der Attraktivitäten';



COMMENT ON COLUMN "public"."platzdaten2"."pl_plz" IS 'Neue Postleitzahl, rein nummerisch';



COMMENT ON COLUMN "public"."platzdaten2"."pl_dauer" IS 'Laufzeit des Platzes';



COMMENT ON COLUMN "public"."platzdaten2"."va_land" IS 'Veranstalter, Land';



COMMENT ON COLUMN "public"."platzdaten2"."org_on_bew" IS 'Online-Bewerbung?';



COMMENT ON COLUMN "public"."platzdaten2"."org_on_name" IS 'Begriff, der auf der Webseite gefunden wurde';



ALTER TABLE "public"."platzdaten2" ALTER COLUMN "nr" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."platzdaten2_nr_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "public"."platzdaten_duplicate" (
    "pl_ort" "text",
    "nr" bigint NOT NULL,
    "va_adresse" "text",
    "kal_notiz" "text" DEFAULT ''::"text",
...
ALTER TABLE "public"."platzdaten_duplicate" OWNER TO "postgres";


COMMENT ON TABLE "public"."platzdaten_duplicate" IS 'This is a duplicate of platzdaten';



COMMENT ON COLUMN "public"."platzdaten_duplicate"."pl_ort" IS 'Platz, Ort';



COMMENT ON COLUMN "public"."platzdaten_duplicate"."va_adresse" IS 'Veranstalter, Strassenname';



COMMENT ON COLUMN "public"."platzdaten_duplicate"."int_kontrolle" IS 'Internes Kontrollfeld';



COMMENT ON COLUMN "public"."platzdaten_duplicate"."pl_beschreibung" IS 'Beschreibung des Platzes';



COMMENT ON COLUMN "public"."platzdaten_duplicate"."pl_web" IS 'Platz, Webseite';



COMMENT ON COLUMN "public"."platzdaten_duplicate"."va_web" IS 'Veranstalter Webseite';



COMMENT ON COLUMN "public"."platzdaten_duplicate"."va_name" IS 'Veranstalter-Name';



COMMENT ON COLUMN "public"."platzdaten_duplicate"."pl_bez" IS 'Bezeichnung des Platzes';



COMMENT ON COLUMN "public"."platzdaten_duplicate"."XXX_pl_plz_alt" IS 'Alte Postleitzahl mit "D-"';



COMMENT ON COLUMN "public"."platzdaten_duplicate"."va_ort" IS 'Veranstalter, Ort';



COMMENT ON COLUMN "public"."platzdaten_duplicate"."pl_location" IS 'Platz, Lage des Platzes, Ortsbezeichnung';



COMMENT ON COLUMN "public"."platzdaten_duplicate"."kal_region" IS 'Kalender-Region';



COMMENT ON COLUMN "public"."platzdaten_duplicate"."pl_start" IS 'Platz, Startdatum';



COMMENT ON COLUMN "public"."platzdaten_duplicate"."pl_ende" IS 'Platz Enddatum';



COMMENT ON COLUMN "public"."platzdaten_duplicate"."futur_start" IS 'Zukünftige Termine Start';



COMMENT ON COLUMN "public"."platzdaten_duplicate"."pl_lat" IS 'Platz, Längengrad';



COMMENT ON COLUMN "public"."platzdaten_duplicate"."pl_lon" IS 'Platz, Breitengrad';



COMMENT ON COLUMN "public"."platzdaten_duplicate"."pl_gplus" IS 'Platz, G+-GeoDaten';



COMMENT ON COLUMN "public"."platzdaten_duplicate"."pl_attr" IS 'Platz, Anzahl der Attraktivitäten';



COMMENT ON COLUMN "public"."platzdaten_duplicate"."pl_plz" IS 'Neue Postleitzahl, rein nummerisch';



COMMENT ON COLUMN "public"."platzdaten_duplicate"."pl_dauer" IS 'Laufzeit des Platzes';



COMMENT ON COLUMN "public"."platzdaten_duplicate"."va_land" IS 'Veranstalter, Land';



COMMENT ON COLUMN "public"."platzdaten_duplicate"."org_on_bew" IS 'Online-Bewerbung?';



COMMENT ON COLUMN "public"."platzdaten_duplicate"."org_on_name" IS 'Begriff, der auf der Webseite gefunden wurde';



ALTER TABLE "public"."platzdaten_duplicate" ALTER COLUMN "nr" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."platzdaten_duplicate_nr_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
COMMENT ON TABLE "public"."platzdaten_staging" IS 'This is a duplicate of platzdaten';



COMMENT ON COLUMN "public"."platzdaten_staging"."pl_ort" IS 'Platz, Ort';



COMMENT ON COLUMN "public"."platzdaten_staging"."va_adresse" IS 'Veranstalter, Strassenname';



COMMENT ON COLUMN "public"."platzdaten_staging"."int_kontrolle" IS 'Internes Kontrollfeld';



COMMENT ON COLUMN "public"."platzdaten_staging"."pl_beschreibung" IS 'Beschreibung des Platzes';



COMMENT ON COLUMN "public"."platzdaten_staging"."pl_web" IS 'Platz, Webseite';



COMMENT ON COLUMN "public"."platzdaten_staging"."va_web" IS 'Veranstalter Webseite';



COMMENT ON COLUMN "public"."platzdaten_staging"."va_name" IS 'Veranstalter-Name';



COMMENT ON COLUMN "public"."platzdaten_staging"."pl_bez" IS 'Bezeichnung des Platzes';



COMMENT ON COLUMN "public"."platzdaten_staging"."XXX_pl_plz_alt" IS 'Alte Postleitzahl mit "D-"';



COMMENT ON COLUMN "public"."platzdaten_staging"."va_ort" IS 'Veranstalter, Ort';



COMMENT ON COLUMN "public"."platzdaten_staging"."pl_location" IS 'Platz, Lage des Platzes, Ortsbezeichnung';



COMMENT ON COLUMN "public"."platzdaten_staging"."kal_region" IS 'Kalender-Region';



COMMENT ON COLUMN "public"."platzdaten_staging"."pl_start" IS 'Platz, Startdatum';



COMMENT ON COLUMN "public"."platzdaten_staging"."pl_ende" IS 'Platz Enddatum';



COMMENT ON COLUMN "public"."platzdaten_staging"."futur_start" IS 'Zukünftige Termine Start';



COMMENT ON COLUMN "public"."platzdaten_staging"."pl_lat" IS 'Platz, Längengrad';



COMMENT ON COLUMN "public"."platzdaten_staging"."pl_lon" IS 'Platz, Breitengrad';



COMMENT ON COLUMN "public"."platzdaten_staging"."pl_gplus" IS 'Platz, G+-GeoDaten';



COMMENT ON COLUMN "public"."platzdaten_staging"."pl_attr" IS 'Platz, Anzahl der Attraktivitäten';



COMMENT ON COLUMN "public"."platzdaten_staging"."pl_plz" IS 'Neue Postleitzahl, rein nummerisch';



COMMENT ON COLUMN "public"."platzdaten_staging"."pl_dauer" IS 'Laufzeit des Platzes';



COMMENT ON COLUMN "public"."platzdaten_staging"."va_land" IS 'Veranstalter, Land';



COMMENT ON COLUMN "public"."platzdaten_staging"."org_on_bew" IS 'Online-Bewerbung?';



COMMENT ON COLUMN "public"."platzdaten_staging"."org_on_name" IS 'Begriff, der auf der Webseite gefunden wurde';



ALTER TABLE "public"."platzdaten_staging" ALTER COLUMN "nr" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."platzdaten_staging_nr_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."XXX-global_events"
...
ALTER TABLE ONLY "public"."platzdaten2"
    ADD CONSTRAINT "platzdaten2_pkey" PRIMARY KEY ("nr");



ALTER TABLE ONLY "public"."platzdaten_duplicate"
    ADD CONSTRAINT "platzdaten_duplicate_pkey" PRIMARY KEY ("nr");
...
ALTER TABLE ONLY "public"."platzdaten_staging"
    ADD CONSTRAINT "platzdaten_staging_pkey" PRIMARY KEY ("nr");
...
CREATE UNIQUE INDEX "platzdaten2_NR_idx" ON "public"."platzdaten2" USING "btree" ("nr");



CREATE UNIQUE INDEX "platzdaten_duplicate_NR_idx" ON "public"."platzdaten_duplicate" USING "btree" ("nr");



CREATE UNIQUE INDEX "platzdaten_staging_NR_idx" ON "public"."platzdaten_staging" USING "btree" ("nr");
...
CREATE POLICY "Authenticated users can insert global events" ON "public"."XXX-global_events" FOR INSERT TO "authenticated" WITH CHECK (true);



CREATE POLICY "Authenticated users can view global events" ON "public"."XXX-global_events" FOR SELECT TO "authenticated" USING (true);
...
ALTER TABLE "public"."XXX-global_events" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."platzdaten2" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."platzdaten_duplicate" ENABLE ROW LEVEL SECURITY;
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."XXX-global_events";
...
GRANT ALL ON SEQUENCE "public"."Stadtdaten_nr_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."Stadtdaten_nr_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."Stadtdaten_nr_seq" TO "service_role";



GRANT ALL ON TABLE "public"."XXX-global_events" TO "anon";
GRANT ALL ON TABLE "public"."XXX-global_events" TO "authenticated";
GRANT ALL ON TABLE "public"."XXX-global_events" TO "service_role";
...
GRANT ALL ON TABLE "public"."platzdaten2" TO "anon";
GRANT ALL ON TABLE "public"."platzdaten2" TO "authenticated";
GRANT ALL ON TABLE "public"."platzdaten2" TO "service_role";



GRANT ALL ON SEQUENCE "public"."platzdaten2_nr_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."platzdaten2_nr_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."platzdaten2_nr_seq" TO "service_role";
...
GRANT ALL ON TABLE "public"."platzdaten_duplicate" TO "anon";
GRANT ALL ON TABLE "public"."platzdaten_duplicate" TO "authenticated";
GRANT ALL ON TABLE "public"."platzdaten_duplicate" TO "service_role";



GRANT ALL ON SEQUENCE "public"."platzdaten_duplicate_nr_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."platzdaten_duplicate_nr_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."platzdaten_duplicate_nr_seq" TO "service_role";
...
GRANT ALL ON SEQUENCE "public"."platzdaten_staging_nr_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."platzdaten_staging_nr_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."platzdaten_staging_nr_seq" TO "service_role";
